...
const About = () => {
  ...
  useEffect(() => {
    axios
      .get("https://admin-1-49ek.onrender.com/api/feedbacks")
      .then((response) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("https://admin-1-49ek.onrender.com/api/feedbacks", formData);
      alert("Feedback submitted successfully!");

      // Refresh feedback list after submission
      axios.get("https://admin-1-49ek.onrender.com/api/feedbacks").then((response) => {
